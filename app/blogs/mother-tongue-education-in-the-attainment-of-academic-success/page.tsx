...
import { blogData6 } from "@/components/content";
...
const page = () => {
    ...
    function createMarkup() {
        return { __html: blogData6?.content || "" };
      }
      ...
      <div className="container blog-details">
        <div className="flex pt-10">
          <div className="">
            ...
            <Heading className="mt-2 mb-8">{blogData6?.title}</Heading>
            <Image
              src={blogData6?.image || ""}
            ...
            <span className="w-full  gap-7  md:px-[10%]">Author: <strong>{blogData6?.author}</strong></span>
          </div>
