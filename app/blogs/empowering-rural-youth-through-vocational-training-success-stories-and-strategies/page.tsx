...
import { blogData5 } from "@/components/content";
...
const page = () => {
    ...
    function createMarkup() {
        return { __html: blogData5?.content || "" };
      }
      ...
      <div className="container blog-details">
        <div className="flex pt-10">
          <div className="">
            ...
            <Heading className="mt-2 mb-8">{blogData5?.title}</Heading>
            <Image
              src={blogData5?.image || ""}
            ...
            <span className="w-full  gap-7  md:px-[10%]">Author: <strong>{blogData5?.author}</strong></span>
          </div>
