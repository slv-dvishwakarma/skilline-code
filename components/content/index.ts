...
export const courseData = [
  ...
  },
  {
    ...
    cousedescription: "Master data structures and algorithms to optimize AI models, enabling efficient data processing and intelligent decision-making.",
    link: {
      label: "Read More",
      url: "#",
      target: "_self"
